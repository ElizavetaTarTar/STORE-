...
Parsing - содержит блокнот [jupyter notebook] с процессом парсинга (ссылка на блокт с парсингом на диске:  ) и полученный [датафрейм](https://github.com/ElizavetaTarTar/STORE-/blob/main/Parcing/Dataframe_Girlzzz.csv).
